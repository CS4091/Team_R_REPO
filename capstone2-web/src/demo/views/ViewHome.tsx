  ...
  return (
    <Container>
      ...
      <Typography align="center" paragraph>
        This application is for our senior project in Computer Science at Missouri S&T. The left side is a 2D grid that the user can control with a bot.
      </Typography>
